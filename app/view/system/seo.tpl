...
<tr><th class="span2">SEO</th><th></th></tr>
	...
	<tr>
		<td   >描述</td>
		<td  ><input type="text" name="description" value="{$config.description}" class="input-large"></td>

	</tr>
	
		<tr>
		<td   >统计代码</td>
		<td  ><input type="text" name="analysis" value="{$config.analysis}" class="input-large"></td>
